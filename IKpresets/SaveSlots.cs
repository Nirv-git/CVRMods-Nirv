        ...
        public static void StoreSlot(string location)
        {
            try
            {
                var updated = new Main.AvatarConfig.AvatarSettings
                {
                    ...
                    IKSpineRelaxIterations = MetaPort.Instance.settings.GetSettingsInt("IKSpineRelaxIterations"),
                    IKMaxSpineAngleFwd = MetaPort.Instance.settings.GetSettingsInt("IKMaxSpineAngleFwd"),
                    IKMaxSpineAngleBack = MetaPort.Instance.settings.GetSettingsInt("IKMaxSpineAngleBack"),
                    IKMaxNeckAngleFwd = MetaPort.Instance.settings.GetSettingsInt("IKMaxNeckAngleFwd"),
                    IKMaxNeckAngleBack = MetaPort.Instance.settings.GetSettingsInt("IKMaxNeckAngleBack"),
                    IKNeckPriority = MetaPort.Instance.settings.GetSettingsInt("IKNeckPriority"),
                    IKStraightSpineAngle = MetaPort.Instance.settings.GetSettingsInt("IKStraightSpineAngle"),
                    IKStraightSpinePower = MetaPort.Instance.settings.GetSettingsInt("IKStraightSpinePower"),
                    ...
                    GeneralPlayerHeight = MetaPort.Instance.settings.GetSettingsInt("GeneralPlayerHeight"),
                    IKCalibrationMode = MetaPort.Instance.settings.GetSettingsInt("IKCalibrationMode"),
                };
